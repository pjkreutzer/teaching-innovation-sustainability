...
### The Scale of Challenges Is Grand
...
## Bottom Up Change Policy -- Mulit-Level Perspective
...
The sociotechnical regime is routed in the evolutionary economic work of Nelson and Winters 1982
<!-- TODO: add citation -->
...
Ontologies are specifications of conceptualizations.
They express particular theories about things that exist.
...
The invasion of Ukraine is a drastic and sudden change in the landscape.
The socio-technical regime of, for example, Germany was surprised by this sudden development.
We will see how this development plays out.
But for now it looks as if there is no alternative idea ready enough in Germany to replace the dominant gas-regime.
Instead the regime is going to great lengths to uphold the status-quo.
Thereby also not following the proposed de- and re-alignment path.
...
For my own research, as an example, the ideas of a regime resisting change is influential.
But rather than viewing niche innovations as the main source of change, I am interested in how the regime is influencing the directionality setting (i.e., legitimizing visions) of the transition.
